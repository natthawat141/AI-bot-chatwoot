...
const content = {
    th: {
        ...
        introBody: 'Aion3 Knowledge Management เก็บข้อมูลของธุรกิจไว้เป็นหมวดหมู่ เมื่อเปิดสถานะพร้อมใช้งาน ข้อมูลจะถูกเปิดให้ Knowledge API เพื่อให้ LINE Bot นำไปประกอบคำตอบ',
    ...
    en: {
        ...
        introBody: 'Aion3 Knowledge Management stores business information by type. Once an item is ready and enabled, it is exposed through the Knowledge API for the LINE Bot to use when composing an answer.',
